...
const TrailerItem = () => {
  return (
        <div className="poster ml-2 mx-5 inline-block rounded-3xl mb-8">
            <a href="">
                <TrailerBackgorund alt="" className="w-80 h-52 mr-3 rounded-xl bg-cover transition-transform duration-500 hover:rounded-xl hover:scale-105">
...
const TrailerBackgorund = styled.div`
    background:linear-gradient(rgb(0 0 0 / 50%), rgb(12 12 12)),url(/assets/background2.jpg);
